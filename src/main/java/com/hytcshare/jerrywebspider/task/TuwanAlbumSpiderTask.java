...
public class TuwanAlbumSpiderTask implements Runnable
{
	...
	public void run()
	{
		...
		try
		{
			...
			{
				throw new SpiderException(ExceptionEnum.ENDLINE_ILLEGAL.getCode(),
						ExceptionEnum.ENDLINE_ILLEGAL.getDes());
			}
	...
	public static void main(String[] args)
	{
		...
		String realUrl = tuwanAlbumSpiderTask.translateUrl(
				"http://img4.tuwandata.com/v3/thumb/jpg/NzliYSwxNTgsMTU4LDksMywxLC0xLE5PTkUsLCw5MA==/u/GLDM9lMIBglnFv7YKftLBGMvdHLuuaCeChlsq0Xe5FYcdsnwHww1mBTnGlUSoeUOoTb9mvfPektEbYcun5ZMfGMUcpOxjDMb5Z2SxwM0JaGI.jpg");
